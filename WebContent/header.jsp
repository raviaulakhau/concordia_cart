	...
	src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
	 <script>
        function validateSearchInput() {
            ...
            if (containsScript(searchInput)) {
                alert('Invalid input: JavaScript code not allowed.');
                return false;
            }
            return true;
        }
        ...
        function containsScript(input) {
            // Check if the input contains any script tags or JavaScript code
            return /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/i.test(input);
        }
    </script>
<link rel="stylesheet"
...
<body style="background-color: #D8BFD8;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #4169E1; color: white; padding: 5px;">
		<h2>Concordia Cart</h2>
		<h6>We specialize in Electronics</h6>
		<form class="form-inline" action="index.jsp" method="get" onsubmit="return validateSearchInput();">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<!-- TODO: adminViewProduct to redirect to APPROPRIATE DISCOUNT AND USED PROD TAB -->
						...
						String style1 = "";
						   if (prodDao.productsOutofStock()) { 
						    style1 = "\"background-color: red;\"";
						   }
						 %>
					<li style=<%= style1 %>><a href="adminStock.jsp">Stock</a></li>
					<li><a href="shippedItems.jsp">Shipped</a></li>
					
					<% OrderServiceImpl orderDao = new OrderServiceImpl();
					String style2 = "";
						if (orderDao.getAllUnshippedItems().size() > 0) {
						    style2 = "\"background-color: red;\"";
						}
					%>
					<li style=<%= style2 %>><a href="unshippedItems.jsp">Orders</a></li>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href ="productLessThan3.jsp">Less than three alert</a></li>
							<li><a href ="revenue.jsp">View revenue chart</a></li>
						</ul></li>
					<li><a href="./LogoutSrv">Logout</a></li>

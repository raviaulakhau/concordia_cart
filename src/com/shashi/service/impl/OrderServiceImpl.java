...
public class OrderServiceImpl implements OrderService {
	...
	public List<OrderBean> getAllUnshippedItems() {
		List<OrderBean> unshippedList = new ArrayList<OrderBean>();
		...
		try {
			...
			while (rs.next()) {
				...
				OrderBean unshipped = new OrderBean(rs.getString("orderid"), rs.getString("prodid"), rs.getInt("quantity"),
						rs.getDouble("amount"), rs.getInt("shipped"));

				unshippedList.add(unshipped);
